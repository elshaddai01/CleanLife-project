-- [MAP-02] Both TrackPickupScreen (client) and ActiveJobScreen (collector)
-- need the client's fixed pickup coordinates to draw a destination marker
-- and route line. Rather than a separate call, adding it to the same
-- get_pickup_request_status_for_actor both screens already poll.
