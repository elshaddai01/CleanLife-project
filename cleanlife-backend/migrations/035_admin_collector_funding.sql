ALTER TYPE wallet_tx_type_enum ADD VALUE IF NOT EXISTS 'admin_funding';
...
BEGIN
    ...
    IF p_type IN ('top_up', 'job_earnings', 'referral_bonus', 'admin_funding') THEN
        v_delta := p_amount;
    ...
    END IF;
    IF v_current_balance IS NULL THEN RAISE EXCEPTION 'owner not found'; END IF;
